...
/**
 * Servlet implementation class CheckUncheckServlet
 */
@WebServlet("/CheckUncheckServlet")
public class CheckUncheckServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		userByLogin.checkTaskStatus(Integer.parseInt(taskId));
